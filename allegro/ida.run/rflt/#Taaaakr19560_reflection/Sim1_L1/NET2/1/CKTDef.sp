...
B_SpeedXP_auto_D1     Power_D1     Ground    nd_out_D1    nd_in_D1    nd_en_D1    Ground    nd_out_of_in_D1     Power_D1     Ground
...
+    pin = D1
+    component = 'U8'
Vpwr_D1  Power_D1  Ground 2.500000e+00
...
B_SpeedXP_auto_D2     Power_D2     Ground    nd_out_D2    nd_in_D2    nd_en_D2    Ground    nd_out_of_in_D2     Power_D2     Ground
+    file = '#taaaakr19560_reflection_u8.ibs' model = 'cds_bi_gen_2p5v_10_10pf'
+    Typ = typ
+    buffer = input_output
+    package = yes
+    pin = D2
+    component = 'U8'
Vpwr_D2  Power_D2  Ground 2.500000e+00
...
.Print v(Xpartial.D1 0)
.Print v(Xpartial.D2 0)
.Print v(Xpartial.D1 Xpartial.D2)
.ENDS
