...
B_SpeedXP_auto_H10     Power_H10     Ground    nd_out_H10    nd_in_H10    nd_en_H10    Ground    nd_out_of_in_H10     Power_H10     Ground
...
+    pin = H10
+    component = 'U8'
Vpwr_H10  Power_H10  Ground 2.500000e+00
...
B_SpeedXP_auto_H9     Power_H9     Ground    nd_out_H9    nd_in_H9    nd_en_H9    Ground    nd_out_of_in_H9     Power_H9     Ground
+    file = '#taaaakr19560_reflection_u8.ibs' model = 'cds_bi_gen_2p5v_10_10pf'
+    Typ = typ
+    buffer = input_output
+    package = yes
+    pin = H9
+    component = 'U8'
Vpwr_H9  Power_H9  Ground 2.500000e+00
...
.Print v(Xpartial.H10 0)
.Print v(Xpartial.H9 0)
.Print v(Xpartial.H10 Xpartial.H9)
.ENDS
