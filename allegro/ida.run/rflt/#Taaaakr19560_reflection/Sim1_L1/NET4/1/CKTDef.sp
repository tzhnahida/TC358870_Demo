...
B_SpeedXP_auto_3     Power_3     Ground    nd_out_3    nd_in_3    nd_en_3    Ground    nd_out_of_in_3     Power_3     Ground
+    file = '#taaaakr19560_reflection_hdmi1.ibs' model = 'cds_bi_gen_2p5v_10_10pf'
+    Typ = typ
+    buffer = input_output
+    package = yes
+    pin = 3
+    component = 'HDMI1'
Vpwr_3  Power_3  Ground 2.500000e+00
...
B_SpeedXP_auto_1     Power_1     Ground    nd_out_1    nd_in_1    nd_en_1    Ground    nd_out_of_in_1     Power_1     Ground
+    file = '#taaaakr19560_reflection_esd1.ibs' model = 'cds_bi_gen_2p5v_10_10pf'
+    Typ = typ
+    buffer = input_output
+    package = yes
+    pin = 1
...
B_SpeedXP_auto_F1     Power_F1     Ground    nd_out_F1    nd_in_F1    nd_en_F1    Ground    nd_out_of_in_F1     Power_F1     Ground
...
+    pin = F1
+    component = 'U8'
Vpwr_F1  Power_F1  Ground 2.500000e+00
...
B_SpeedXP_auto_F2     Power_F2     Ground    nd_out_F2    nd_in_F2    nd_en_F2    Ground    nd_out_of_in_F2     Power_F2     Ground
+    file = '#taaaakr19560_reflection_u8.ibs' model = 'cds_bi_gen_2p5v_10_10pf'
+    Typ = typ
+    buffer = input_output
+    package = yes
+    pin = F2
+    component = 'U8'
Vpwr_F2  Power_F2  Ground 2.500000e+00
...
.Print v(Xpartial.1 Xpartial.2)
.Print v(Xpartial.10 Xpartial.2)
.ENDS
...
.Print v(Xpartial.1 0)
.Print v(Xpartial.3 0)
.Print v(Xpartial.1 Xpartial.3)
.ENDS
...
.Print v(Xpartial.F1 0)
.Print v(Xpartial.F2 0)
.Print v(Xpartial.F1 Xpartial.F2)
.ENDS
