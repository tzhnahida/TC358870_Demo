...
B_SpeedXP_auto_E1     Power_E1     Ground    nd_out_E1    nd_in_E1    nd_en_E1    Ground    nd_out_of_in_E1     Power_E1     Ground
...
+    pin = E1
+    component = 'U8'
Vpwr_E1  Power_E1  Ground 2.500000e+00
...
B_SpeedXP_auto_E2     Power_E2     Ground    nd_out_E2    nd_in_E2    nd_en_E2    Ground    nd_out_of_in_E2     Power_E2     Ground
+    file = '#taaaakr19560_reflection_u8.ibs' model = 'cds_bi_gen_2p5v_10_10pf'
+    Typ = typ
+    buffer = input_output
+    package = yes
+    pin = E2
+    component = 'U8'
Vpwr_E2  Power_E2  Ground 2.500000e+00
...
.Print v(Xpartial.E1 0)
.Print v(Xpartial.E2 0)
.Print v(Xpartial.E1 Xpartial.E2)
.ENDS
