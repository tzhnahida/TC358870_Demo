...
+    file = '#taaaakr19560_reflection_hdmi1.ibs' model = 'cds_bi_gen_2p5v_10_10pf'
+    Typ = typ
+    buffer = input_output
+    package = yes
+    pin = 10
...
B_SpeedXP_auto_4     Power_4     Ground    nd_out_4    nd_in_4    nd_en_4    Ground    nd_out_of_in_4     Power_4     Ground
+    file = '#taaaakr19560_reflection_esd2.ibs' model = 'cds_bi_gen_2p5v_10_10pf'
+    Typ = typ
+    buffer = input_output
+    package = yes
+    pin = 4
+    component = 'ESD2'
Vpwr_4  Power_4  Ground 2.500000e+00
V_SpeedXP_auto_4_En    nd_en_4    Ground        0.0
...
V_SpeedXP_auto_A5_En    nd_en_A5    Ground        1.0

X_SpeedXP_auto_A5_St     nd_in_A5    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI1_DATA3_P

V_SpeedXP_auto_A6_En    nd_en_A6    Ground        1.0

X_SpeedXP_auto_A6_St     nd_in_A6    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI1_DATA2_P

V_SpeedXP_auto_A7_En    nd_en_A7    Ground        1.0

X_SpeedXP_auto_A7_St     nd_in_A7    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI1_CLK_P

V_SpeedXP_auto_A8_En    nd_en_A8    Ground        1.0

X_SpeedXP_auto_A8_St     nd_in_A8    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI1_DATA1_P

V_SpeedXP_auto_A9_En    nd_en_A9    Ground        1.0

X_SpeedXP_auto_A9_St     nd_in_A9    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI1_DATA0_P

V_SpeedXP_auto_B5_En    nd_en_B5    Ground        1.0

X_SpeedXP_auto_B5_St     nd_in_B5    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI1_DATA3_N

V_SpeedXP_auto_B6_En    nd_en_B6    Ground        1.0

X_SpeedXP_auto_B6_St     nd_in_B6    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI1_DATA2_N

V_SpeedXP_auto_B7_En    nd_en_B7    Ground        1.0

X_SpeedXP_auto_B7_St     nd_in_B7    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI1_CLK_N

V_SpeedXP_auto_B8_En    nd_en_B8    Ground        1.0

X_SpeedXP_auto_B8_St     nd_in_B8    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI1_DATA1_N

V_SpeedXP_auto_B9_En    nd_en_B9    Ground        1.0

X_SpeedXP_auto_B9_St     nd_in_B9    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI1_DATA0_N

B_SpeedXP_auto_C1     Power_C1     Ground    nd_out_C1    nd_in_C1    nd_en_C1    Ground    nd_out_of_in_C1     Power_C1     Ground
...
+    pin = C1
+    component = 'U8'
Vpwr_C1  Power_C1  Ground 2.500000e+00
V_SpeedXP_auto_C1_En    nd_en_C1    Ground        1.0

X_SpeedXP_auto_C1_St     nd_in_C1    Ground        SpeedXP_auto_Stimulus_U8_HDMI_CLK_P

B_SpeedXP_auto_C2     Power_C2     Ground    nd_out_C2    nd_in_C2    nd_en_C2    Ground    nd_out_of_in_C2     Power_C2     Ground
+    file = '#taaaakr19560_reflection_u8.ibs' model = 'cds_bi_gen_2p5v_10_10pf'
+    Typ = typ
+    buffer = input_output
+    package = yes
+    pin = C2
+    component = 'U8'
Vpwr_C2  Power_C2  Ground 2.500000e+00
V_SpeedXP_auto_C2_En    nd_en_C2    Ground        1.0

X_SpeedXP_auto_C2_St     nd_in_C2    Ground        SpeedXP_auto_Stimulus_U8_HDMI_CLK_N

V_SpeedXP_auto_D1_En    nd_en_D1    Ground        1.0

X_SpeedXP_auto_D1_St     nd_in_D1    Ground        SpeedXP_auto_Stimulus_U8_HDMI_DATA0_P

V_SpeedXP_auto_D10_En    nd_en_D10    Ground        1.0

X_SpeedXP_auto_D10_St     nd_in_D10    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI0_DATA3_P

V_SpeedXP_auto_D2_En    nd_en_D2    Ground        1.0

X_SpeedXP_auto_D2_St     nd_in_D2    Ground        SpeedXP_auto_Stimulus_U8_HDMI_DATA0_N

V_SpeedXP_auto_D9_En    nd_en_D9    Ground        1.0

X_SpeedXP_auto_D9_St     nd_in_D9    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI0_DATA3_N

V_SpeedXP_auto_E1_En    nd_en_E1    Ground        1.0

X_SpeedXP_auto_E1_St     nd_in_E1    Ground        SpeedXP_auto_Stimulus_U8_HDMI_DATA1_P

V_SpeedXP_auto_E10_En    nd_en_E10    Ground        1.0

X_SpeedXP_auto_E10_St     nd_in_E10    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI0_DATA2_P

V_SpeedXP_auto_E2_En    nd_en_E2    Ground        1.0

X_SpeedXP_auto_E2_St     nd_in_E2    Ground        SpeedXP_auto_Stimulus_U8_HDMI_DATA1_N

V_SpeedXP_auto_E9_En    nd_en_E9    Ground        1.0

X_SpeedXP_auto_E9_St     nd_in_E9    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI0_DATA2_N

V_SpeedXP_auto_F1_En    nd_en_F1    Ground        1.0

X_SpeedXP_auto_F1_St     nd_in_F1    Ground        SpeedXP_auto_Stimulus_U8_HDMI_DATA2_P

V_SpeedXP_auto_F10_En    nd_en_F10    Ground        1.0

X_SpeedXP_auto_F10_St     nd_in_F10    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI0_CLK_P

V_SpeedXP_auto_F2_En    nd_en_F2    Ground        1.0

X_SpeedXP_auto_F2_St     nd_in_F2    Ground        SpeedXP_auto_Stimulus_U8_HDMI_DATA2_N

V_SpeedXP_auto_F9_En    nd_en_F9    Ground        1.0

X_SpeedXP_auto_F9_St     nd_in_F9    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI0_CLK_N

V_SpeedXP_auto_G10_En    nd_en_G10    Ground        1.0

X_SpeedXP_auto_G10_St     nd_in_G10    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI0_DATA1_P

V_SpeedXP_auto_G9_En    nd_en_G9    Ground        1.0

X_SpeedXP_auto_G9_St     nd_in_G9    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI0_DATA1_N

V_SpeedXP_auto_H10_En    nd_en_H10    Ground        1.0

X_SpeedXP_auto_H10_St     nd_in_H10    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI0_DATA0_P

V_SpeedXP_auto_H9_En    nd_en_H9    Ground        1.0

X_SpeedXP_auto_H9_St     nd_in_H9    Ground        SpeedXP_auto_Stimulus_U8_MIPI_DSI0_DATA0_N
...
V_SpeedXP_auto_11_En    nd_en_11    Ground        0.0


V_SpeedXP_auto_12_En    nd_en_12    Ground        0.0


V_SpeedXP_auto_13_En    nd_en_13    Ground        0.0


V_SpeedXP_auto_14_En    nd_en_14    Ground        0.0


V_SpeedXP_auto_15_En    nd_en_15    Ground        0.0


V_SpeedXP_auto_16_En    nd_en_16    Ground        0.0


V_SpeedXP_auto_17_En    nd_en_17    Ground        0.0


V_SpeedXP_auto_18_En    nd_en_18    Ground        0.0


V_SpeedXP_auto_19_En    nd_en_19    Ground        0.0


V_SpeedXP_auto_2_En    nd_en_2    Ground        0.0


V_SpeedXP_auto_20_En    nd_en_20    Ground        0.0
...
V_SpeedXP_auto_8_En    nd_en_8    Ground        0.0
...
.Print v(Xpartial.4 0)
.Print v(Xpartial.5 0)
.Print v(Xpartial.6 0)
.Print v(Xpartial.7 0)
.Print v(Xpartial.4 Xpartial.5)
.Print v(Xpartial.7 Xpartial.5)
.ENDS
...
.Print v(Xpartial.10 Xpartial.12)
.ENDS
...
.Print v(Xpartial.C1 0)
.Print v(Xpartial.C2 0)
.Print v(Xpartial.C1 Xpartial.C2)
.ENDS
