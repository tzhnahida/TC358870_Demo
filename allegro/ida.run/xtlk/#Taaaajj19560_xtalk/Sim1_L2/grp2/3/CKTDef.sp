...
+    file = '..\..\..\#taaaajj19560_xtalk_hdmi1.ibs' model = 'cds_bi_gen_2p5v_10_10pf'
+    Typ = typ
+    buffer = input_output
+    package = yes
+    pin = 1
...
B_SpeedXP_auto_1     Power_1     Ground    nd_out_1    nd_in_1    nd_en_1    Ground    nd_out_of_in_1     Power_1     Ground
+    file = '..\..\..\#taaaajj19560_xtalk_esd1.ibs' model = 'cds_bi_gen_2p5v_10_10pf'
+    Typ = typ
+    buffer = input_output
+    package = yes
+    pin = 1
...
B_SpeedXP_auto_1     Power_1     Ground    nd_out_1    nd_in_1    nd_en_1    Ground    nd_out_of_in_1     Power_1     Ground
+    file = '..\..\..\#taaaajj19560_xtalk_esd2.ibs' model = 'cds_bi_gen_2p5v_10_10pf'
+    Typ = typ
+    buffer = input_output
+    package = yes
+    pin = 1
